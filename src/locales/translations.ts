...
export const translations: Record<Language, Translations> = {
  en: {
    ...
    contact: {
      ...
      responseDesc: "Your premium Tesla transfer is just moments away.",
  ...
  de: {
    ...
    contact: {
      ...
      responseDesc: "Ihr Premium-Tesla-Transfer ist nur Momente entfernt.",
  ...
  sk: {
    ...
    contact: {
      ...
      responseDesc: "Váš prémiový Tesla transfer je len okamihy ďaleko.",
  ...
  ru: {
    ...
    contact: {
      ...
      responseDesc: "Ваш премиальный трансфер Tesla всего в нескольких минутах.",
